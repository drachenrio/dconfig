    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (command.equals(MenuCreator.NEWKEY)) {
                ...
                if (!AppContext.isConnected()) { // disconnected
            	...
            	if (menuItem.isSelected())
                    ...
                    menuItem.setIcon(DCMenuItem.blankIcon);
                ...
                DlgFind dlg = new DlgFind(AppContext.appContext().getCfgEditor(),
                        "Find");
                dlg.dispose();
                dlg = null;
                ...
                if (new DConfigAttributeDao().save(dcfgObj, attributes)) {
                    model.populateTable(dcfgObj.getAttributesFromDb()); // update table model
                    dcfgObj.setAttributes(attributes); // update attributes after save to db successfully
                    AppContext.appContext().getStateController().updateButtonStates();
                } else {
                ...
                if (rVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    if (importer.doImport()) {
                        ...
                        DialogUtil.showError("Import", "Sorry, an error occurred while importinging data, check log file for details.");
                }
                ...
                // get default connection info first, if no found, open the connection wizard                
