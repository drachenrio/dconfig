...
/**
 *
 * Implementation of table selection listener.
 *
 * @author Jonathan Luo
 */
    ...
    */
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (lsm.isSelectionEmpty()) {
            ...
            tableContext.setSelectedViewRow(selectedRow);
            if (selectedRow != -1) {
                TableSorter tableSorter = TableUtil.getTableModel();
                String attributeName = (String) tableSorter.getValueAt(selectedRow, TableModelImpl.IDX_ATTRIBUTE_NAME);
                tableContext.setSelectedAttributeName(attributeName);
            }
