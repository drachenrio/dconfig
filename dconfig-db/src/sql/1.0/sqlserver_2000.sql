...
CREATE TABLE [dbo].[dconfig_system] (
	[attribute_name] [varchar] (50) COLLATE SQL_Latin1_General_CP1257_CS_AS NOT NULL ,
	[attribute_value] [varchar] (200) COLLATE SQL_Latin1_General_CP1257_CS_AS NOT NULL ,
...
--------------------------------------------------------------------------------
-- 4. add sample attributes (Optional)
...
--------------------------------------------------------------------------------
-- 5. Create a user account 'dcfg' (Optional)
