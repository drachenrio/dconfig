...
--------------------------------------------------------------------------------
-- The scripts below has been executed on MySQL Ver 5.0.16, Ver 4.1.20
--------------------------------------------------------------------------------
-- Sign on as a user with admin role
-- For example, mysql
--------------------------------------------------------------------------------
...
CREATE TABLE     dconfig_key      (
    ...
    PRIMARY KEY  (id),
    UNIQUE index idx_dcfg_key_keyname (     key_name     )
);
...
CREATE TABLE dconfig_attribute (
    ...
    data_type_alias VARCHAR(10) NOT NULL REFERENCES dconfig_datatype(alias),
    ...
    date_modified TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
                  ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY  (id),
    UNIQUE index idx_dcfg_attribute_keyid_attribute (key_id,attribute_name)
);
...
insert into dconfig_key (key_name, date_created) values ('config', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, inherited, date_created) values ('config.datasource', 'Y', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.datasource.oracle', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, inherited, date_created) values ('config.datasource.mysql', 'Y', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.datasource.postgres', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.datasource.sqlserver', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.datasource.derby', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.application', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.webservices', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.system', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('config.cache', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, inherited, date_created) values ('config.view', 'Y', CURRENT_TIMESTAMP);

insert into dconfig_key (key_name, date_created) values ('admin', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('admin.system', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, inherited, date_created) values ('admin.applications', 'Y', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('admin.webservices', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('admin.users', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('admin.database', CURRENT_TIMESTAMP);

insert into dconfig_key (key_name, date_created) values ('user', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('user.preferences', CURRENT_TIMESTAMP);

insert into dconfig_key (key_name, date_created) values ('opensource', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.antivirus', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.software', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.appserver', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.database', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.games', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.ide', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.ide.eclipse', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.ide.netbeans', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.os', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.os.linux', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.os.linux.vendor', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.os.linux.vendor.redhat', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.os.linux.vendor.novell', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.os.linux.vendor.redflag', CURRENT_TIMESTAMP);
insert into dconfig_key (key_name, date_created) values ('opensource.os.opensolaris', CURRENT_TIMESTAMP);
commit;
